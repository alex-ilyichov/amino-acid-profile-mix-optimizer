...
Minimise  sum_j (blend_norm_j - target_j)^2
s.t.      sum_i x_i = 1,  x_i >= 0  (optionally x_i <= max_i)

The objective is a ratio of linear functions — not pure QP — but SLSQP
handles it without issue (smooth, convex on the feasible simplex for
typical food databases).
"""
